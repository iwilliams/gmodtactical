...
function SWEP:Reload()
	...
	self:SetHolsterTimer(self.Owner:GetViewModel():SequenceDuration() + .1)
...
function SWEP:DrawHUD()
	...
	if  self.Owner:KeyDown(IN_ATTACK2) and (self:GetIronsights() == true) and (!self.Owner:KeyDown(IN_SPEED) and !self.Owner:KeyDown(IN_USE) and !self:GetHolsterStatus()) then
