...
// I have nothing to say here because Im a prick
SWEP.Purpose			= ""
SWEP.Instructions			= ""
...
// Is it a pistol, a rifle, a shotgun or a sniper? Choose only one of them or youll fucked up everything. BITCH!
SWEP.Pistol				= false
SWEP.Rifle				= false
SWEP.Shotgun			= false
SWEP.Sniper				= false
...
// Constant accuracy means that your crosshair will not change if youre running, shooting or walking
...
function SWEP:Reload()
	...
	// When the weapon is already doing an animation, just return end because we dont want to interrupt it
...
function SWEP:ReloadAnimation()
	...
	// Reload with the suppressor animation if youre suppressor is on the FUCKING gun
	if self.Weapon:GetDTBool(3) and self.Type == 2 then
...
/*---------------------------------------------------------
   ...
   Desc: Called every frame. Use this function if you dont 
...
function SWEP:Think()
	...
	if self.Weapon:GetDTBool(1) and self.Owner:KeyDown(IN_SPEED) then
		...
		// If youre running or if your weapon is holsted, the third person animation is going to change
...
function SWEP:CrosshairAccuracy()
	...
	// Is it a constant accuracy weapon or is it a NPC? The NPC doesnt need a crosshair. Fuck him!
...
function SWEP:ShootEffects()
	...
	// Add a timer to solve this problem : in multiplayer, when you aim with the ironsights, tracers, effects, etc. still come from where the barrel is when you dont aim with ironsights
...
function SWEP:ShootBullet(damage, recoil, num_bullets, aimcone)
	...
	// Realistic recoil. Only on snipers and shotguns. Disable for the admin gun because if you put the max damage, youll fly like you never fly!
...
function SWEP:RicochetCallback(bouncenum, attacker, tr, dmginfo)
	...
	// Your screen will shake and youll hear the savage hiss of an approaching bullet which passing if someone is shooting at you.
...
function SWEP:CanPrimaryAttack()
	...
	// Clip is empty or youre under water
...
//		self.Weapon:EmitSound("Default.ClipEmpty_Pistol")
	...
	// Youre sprinting or your weapon is holsted
