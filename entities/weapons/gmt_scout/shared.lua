...
if CLIENT then
    ...
    SWEP.IconLetter = "w"
    killicon.Add("cw_ber_scoot", "weaponicons/scoot-k", Color(255, 80, 0, 150))
    SWEP.SelectIcon = surface.GetTextureID("weaponicons/select/steyr")

    SWEP.MuzzleEffect = "ber_sniper"
